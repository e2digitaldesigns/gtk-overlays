...
export const TopicsSmallCNN: React.FC = () => {
  ...
  const showMenu = isVideoViewable && !!activeTopic.video;

  return (
    <Styled.TopicsWrapperSmall showMenu={showMenu}>
